...
class URLSessionHTTPClientTests: XCTestCase {
    ...
    func test_cancelGetFromURLTaks_cancelsURLRequest() {
        let url = anyURL()
    ...
    func test_getFromULR_succeedsOnHTTPURLResponseWithData() {
        let data = anyData()
    ...
    func test_getFromULR_succeedsWithEmptyDataOnHTTPURLResponseWithNilData() {
        let response = anyHTTPURLResponse()
    ...
    private class URLProtocolStub: URLProtocol { //this is a Class! :O
        ...
        override func startLoading() {
            if let requestObeserver = URLProtocolStub.requestObserver {
                client?.urlProtocolDidFinishLoading(self)
                return requestObeserver(request)
            }
